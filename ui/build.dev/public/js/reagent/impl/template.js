...
var G__13861 = o;
(G__13861[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13866_SHARP_);
...
var vec__13870 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13870,(0),null);
var id = cljs.core.nth.call(null,vec__13870,(1),null);
var class$ = cljs.core.nth.call(null,vec__13870,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___13874 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___13874 == null)){
} else {
var key_13875 = temp__5724__auto___13874;
...
var G__13876 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__13876["name"] = c);
...
var len__4730__auto___13882 = arguments.length;
var i__4731__auto___13883 = (0);
while(true){
if((i__4731__auto___13883 < len__4730__auto___13882)){
args__4736__auto__.push((arguments[i__4731__auto___13883]));

var G__13884 = (i__4731__auto___13883 + (1));
i__4731__auto___13883 = G__13884;
continue;
} else {
}
break;
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13881,seq13880__$1);
});
...
break;
default:
var G__13887 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__13887;
continue;
...
var n__4607__auto___13889 = a.length;
var i_13890 = (0);
while(true){
if((i_13890 < n__4607__auto___13889)){
(a[i_13890] = reagent.impl.template.as_element.call(null,(a[i_13890])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___13892 = a.length;
var i_13893 = (0);
while(true){
if((i_13893 < n__4607__auto___13892)){
var val_13894 = (a[i_13893]);
if(((cljs.core.vector_QMARK_.call(null,val_13894)) && ((reagent.impl.template.key_from_vec.call(null,val_13894) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13893] = reagent.impl.template.as_element.call(null,val_13894));
...
var ctx = ({});
var vec__13896 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13896,(0),null);
var derefed = cljs.core.nth.call(null,vec__13896,(1),null);
...
var G__13899 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13899) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__13899){
