...
return [(function (){var pred__14015 = cljs.core.instance_QMARK_;
var expr__14016 = reactive_val;
if(cljs.core.truth_(pred__14015.call(null,reagent.ratom.RAtom,expr__14016))){
return "ra";
} else {
if(cljs.core.truth_(pred__14015.call(null,reagent.ratom.RCursor,expr__14016))){
return "rc";
} else {
if(cljs.core.truth_(pred__14015.call(null,reagent.ratom.Reaction,expr__14016))){
return "rx";
} else {
if(cljs.core.truth_(pred__14015.call(null,reagent.ratom.Track,expr__14016))){
return "tr";
} else {
return "other";
}
