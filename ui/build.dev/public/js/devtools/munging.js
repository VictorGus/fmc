...
var o15576 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15576["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15577 = temp__5718__auto____$1;
return (o15577["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14686__auto__ = f;
return (o__14686__auto__["toString"]).call(o__14686__auto__);
} else {
return "";
}
}catch (e15578){var _ = e15578;
return "";
}});
...
try{var o__14686__auto___15580 = t;
(o__14686__auto___15580["cljs$lang$ctorPrWriter"]).call(o__14686__auto___15580,t,writer);
}catch (e15579){var __15581 = e15579;
}
...
var char_code = (function (){var o__14686__auto__ = (new String(char$));
return (o__14686__auto__["charCodeAt"]).call(o__14686__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14686__auto__ = String;
return (o__14686__auto__["fromCharCode"]).call(o__14686__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15582 = num_code;
switch (G__15582) {
case (1):
return (185);
...
var o__14686__auto__ = String;
return (o__14686__auto__["fromCharCode"]).call(o__14686__auto__,superscript_code);
});
/**
...
}catch (e15584){var _e__14693__auto__ = e15584;
return false;
}})())){
...
var vec__15585 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15585,(0),null);
...
var temp__5718__auto____$1 = (o15588["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15589 = temp__5718__auto____$1;
return (o15589["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___15596 = arguments.length;
var i__4731__auto___15597 = (0);
while(true){
if((i__4731__auto___15597 < len__4730__auto___15596)){
args__4736__auto__.push((arguments[i__4731__auto___15597]));

var G__15598 = (i__4731__auto___15597 + (1));
i__4731__auto___15597 = G__15598;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15592){
var vec__15593 = p__15592;
var ns_detector = cljs.core.nth.call(null,vec__15593,(0),null);
...
var G__15599 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15600 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15599;
remaining_tokens = G__15600;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15590){
var G__15591 = cljs.core.first.call(null,seq15590);
var seq15590__$1 = cljs.core.next.call(null,seq15590);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15591,seq15590__$1);
});
...
var vec__15604 = cljs.core.split_with.call(null,(function (p1__15603_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15603_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15604,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15604,(1),null);
...
var vec__15610 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15610,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15610,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15613 = cljs.core.rest.call(null,remaining_tokens);
var G__15614 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15613;
name_tokens = G__15614;
continue;
} else {
...
var vec__15617 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15617,(0),null);
var arity = cljs.core.nth.call(null,vec__15617,(1),null);
var vec__15620 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15620,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15620,(1),null);
var vec__15623 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15623,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15623,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15623,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15623,(3),null);
...
var vec__15629 = result;
var munged_ns = cljs.core.nth.call(null,vec__15629,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15629,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15629,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15629,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15629,(4),null);
var arity = cljs.core.nth.call(null,vec__15629,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__15633 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__15633,(0),null);
var args = cljs.core.nth.call(null,vec__15633,(1),null);
var vec__15636 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15636,(0),null);
var name = cljs.core.nth.call(null,vec__15636,(1),null);
...
var G__15639 = (arity + (1));
var G__15640 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15641){
var vec__15642 = p__15641;
var arity = cljs.core.nth.call(null,vec__15642,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15642,(1),null);
...
return cljs.core.get.call(null,arities,p1__15645_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15646_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___15653 = arguments.length;
var i__4731__auto___15654 = (0);
while(true){
if((i__4731__auto___15654 < len__4730__auto___15653)){
args__4736__auto__.push((arguments[i__4731__auto___15654]));

var G__15655 = (i__4731__auto___15654 + (1));
i__4731__auto___15654 = G__15655;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15649){
var vec__15650 = p__15649;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15650,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15647){
var G__15648 = cljs.core.first.call(null,seq15647);
var seq15647__$1 = cljs.core.next.call(null,seq15647);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15648,seq15647__$1);
});
...
var G__15656 = arg;
var G__15656__$1 = (((G__15656 instanceof cljs.core.Keyword))?G__15656.fqn:null);
switch (G__15656__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15658__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15658__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15658__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15658__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15659 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15659,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15659,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15659,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15659,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15659,(4),null);
var arity = cljs.core.nth.call(null,vec__15659,(5),null);
...
var o__14686__auto__ = f;
return (o__14686__auto__["getBasis"]).call(o__14686__auto__);
});
/**
...
}catch (e15663){var _e__14693__auto__ = e15663;
...
var G__15664 = (obj[cljs.core.first.call(null,path)]);
var G__15665 = cljs.core.rest.call(null,path);
obj = G__15664;
path = G__15665;
continue;
} else {
...
return (function (accum,p__15666){
var vec__15667 = p__15666;
var bit = cljs.core.nth.call(null,vec__15667,(0),null);
var protocol = cljs.core.nth.call(null,vec__15667,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15670){
var vec__15671 = p__15670;
var ns = cljs.core.nth.call(null,vec__15671,(0),null);
var name = cljs.core.nth.call(null,vec__15671,(1),null);
var selector = cljs.core.nth.call(null,vec__15671,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15676,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15676,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15674_SHARP_){
return (obj[cljs.core.first.call(null,p1__15674_SHARP_)]);
});})(name,sorted_matches,vec__15676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
