...
var G__22737 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22737;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22738 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22738,ch);
...
if(("\\" === ch__$1)){
var ch_22739__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22739__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22739__$2);
} else {
}

var G__22740 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22740;
continue;
}
}
...
var G__22751 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22751;
continue;
}
}
...
var vec__22766 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22766,(0),null);
var start_column = cljs.core.nth.call(null,vec__22766,(1),null);
...
var vec__22769 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22769,(0),null);
var end_column = cljs.core.nth.call(null,vec__22769,(1),null);
...
var sb = (function (){var G__22772 = (new goog.string.StringBuffer());
G__22772.append(initch);
...
var G__22774 = (function (){var G__22773 = sb;
G__22773.append(ch);

return G__22773;
})();
var G__22775 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22774;
ch = G__22775;
continue;
}
...
switch (G__22778) {
case "\\":
var G__22782 = (function (){var G__22779 = sb;
G__22779.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22779;
})();
var G__22783 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22782;
ch = G__22783;
continue;
...
break;
default:
var G__22784 = (function (){var G__22780 = sb;
G__22780.append(ch);

return G__22780;
})();
var G__22785 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22784;
ch = G__22785;
continue;
...
var vec__22786 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22786,(0),null);
var end_column = cljs.core.nth.call(null,vec__22786,(1),null);
...
var vec__22789 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22789,(0),null);
var column = cljs.core.nth.call(null,vec__22789,(1),null);
...
var vec__22794 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22794,(0),null);
var column = cljs.core.nth.call(null,vec__22794,(1),null);
...
var vec__22799 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22799,(0),null);
var column = cljs.core.nth.call(null,vec__22799,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var start_line = cljs.core.nth.call(null,vec__22804,(0),null);
var start_column = cljs.core.nth.call(null,vec__22804,(1),null);
...
var vec__22807 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22807,(0),null);
var end_column = cljs.core.nth.call(null,vec__22807,(1),null);
...
var G__22810 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22810,true,null,opts,pending_forms);
...
var G__22811 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22811)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22811)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22811)){
...
var _STAR_suppress_read_STAR__orig_val__22812 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22813 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22813;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22812;
}});
...
var G__22814 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22814,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22814,rdr,first_line);
...
var G__22818 = matched;
var G__22819 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22818;
finished = G__22819;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__22820 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22821 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22821;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22820;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22822 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22823 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__22823;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22824 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22824,"(");
...
var G__22825 = (i + (1));
var G__22826 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__22822;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22827 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22827);
...
var G__22828 = cljs.core.next.call(null,s__$1);
var G__22829 = ret;
s__$1 = G__22828;
r = G__22829;
continue;
...
var G__22830 = cljs.core.next.call(null,s);
var G__22831 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22830;
key_vals = G__22831;
continue;
} else {
...
var gensym_env_orig_val__22835 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22836 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__22836;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__22835;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22837 = token;
var G__22837__$1 = (((G__22837 == null))?null:cljs.core.subs.call(null,G__22837,(1)));
var G__22837__$2 = (((G__22837__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22837__$1));
var G__22837__$3 = (((G__22837__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22837__$2));
var G__22837__$4 = (((G__22837__$3 == null))?null:cljs.core.symbol.call(null,G__22837__$3));
if((G__22837__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22837__$4);
}
})():(function (){var G__22838 = token;
var G__22838__$1 = (((G__22838 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22838));
if((G__22838__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22838__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e22845){if((e22845 instanceof Error)){
var e = e22845;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22849,reader){
...
var eof = cljs.core.get.call(null,map__22850__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___22858 = arguments.length;
var i__4731__auto___22859 = (0);
while(true){
if((i__4731__auto___22859 < len__4730__auto___22858)){
args__4736__auto__.push((arguments[i__4731__auto___22859]));

var G__22860 = (i__4731__auto___22859 + (1));
i__4731__auto___22859 = G__22860;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22856){
var G__22857 = cljs.core.first.call(null,seq22856);
var seq22856__$1 = cljs.core.next.call(null,seq22856);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22857,seq22856__$1);
});
